...
def data_process():
    dara_root = 'GoogLeNet/data/train'
    # 数据集计算得出的均值和标准差
...
def train(model, train_data_loader, val_data_loader, num_epochs):
    ...
    # 保存最优模型及训练数据
    torch.save(best_model, 'GoogLeNet/googlenet.pth')
    ...
    train_process.to_json("GoogLeNet/train_process.json", orient="records", indent=4)
...
if __name__ == "__main__":
    ...
    train_process = train(GoogLeNet, train_data_loader, val_data_loader, num_epochs=50)
